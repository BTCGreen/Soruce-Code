...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* greenbitcoin features */
        {"greenbitcoin", "masternode", &masternode, true, true, false},
        {"greenbitcoin", "masternodelist", &masternodelist, true, true, false},
        {"greenbitcoin", "mnbudget", &mnbudget, true, true, false},
        {"greenbitcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"greenbitcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"greenbitcoin", "mnsync", &mnsync, true, true, false},
        {"greenbitcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"greenbitcoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use greenbitcoind, or the -server option to greenbitcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> greenbitcoin-cli " + methodname + " " + args + "\n";
}
