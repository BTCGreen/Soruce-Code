...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GBTC Core"),
     ...
     * override -datadir in the greenbitcoin.conf file in the default data directory
     * (to be consistent with greenbitcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
