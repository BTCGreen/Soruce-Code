...
/** Utility functions used by the GBTC Qt UI.
 */
namespace GUIUtil
{
...
// Render GBTC addresses in monospace font
...
// Parse "greenbitcoin:" URI into recipient object, return true on successful parsing
