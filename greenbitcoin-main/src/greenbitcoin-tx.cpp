...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("greenbitcoin Core greenbitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  greenbitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded greenbitcoin transaction") + "\n" +
                               "  greenbitcoin-tx [options] -create [commands]   " + _("Create hex-encoded greenbitcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded greenbitcoin transaction
